...
@section('title', 'Halaman Beranda Utama')
                        ...
                        <table class="table align-middle">
                                ...
                                <td>
                                    <a href="agents" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="admin/assets/images/user-42.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="agents" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="admin/assets/images/user-44.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="agents" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="admin/assets/images/user-45.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="agents" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="admin/assets/images/user-46.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="agents" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="admin/assets/images/user-47.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="agents" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="admin/assets/images/user-48.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="agents" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="admin/assets/images/user-49.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="agents" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="admin/assets/images/user-50.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="agents" class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="admin/assets/images/user-51.jpg" class="wh-34 rounded-circle" alt="user">
                                        </div>
                                        <div class="flex-grow-1 ms-2 position-relative top-1">
